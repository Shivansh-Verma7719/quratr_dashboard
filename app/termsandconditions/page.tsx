      ...
      <div className="min-h-screen font-sans overflow-x-hidden bg-white text-text">
        ...
        <main className="container mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
            ...
            <p>
              Welcome to <b>Quratr</b> (“Company”, “we”, “our”, “us”)!
            </p>
            <p>
              These Terms of Service (“Terms”, “Terms of Service”) govern your
              use of our website located at <b>quratr.com</b> (together or
              individually “Service”) operated by <b>Quratr</b>.
            </p>
            <p>
            ...
            <p>
              Quratr has the right but not the obligation to monitor and edit
              all Content provided by users.
            </p>
            <p>
              In addition, Content found on or through this Service are the
              property of Quratr or used with permission. You may not
            ...
            <p>
              ...
              exclusive property of Quratr and its licensors. Service is
              ...
              product or service without the prior written consent of Quratr.
            </p>
            <p>
            ...
            <p>
              ...
              that are not owned or controlled by Quratr.
            </p>
            <p>
              Quratr has no control over, and assumes no responsibility for the
